...
# Slot: experimenter_name 


_Full name of the person who performed the experiment. Written as #Experimenter_Name: in the file header._
...
URI: [fof_ct:experimenter_name](https://w3id.org/fof-ct/experimenter_name)
...
| ---  | ---  |
| self | fof_ct:experimenter_name |
| native | fof_ct:experimenter_name |
...
description: 'Full name of the person who performed the experiment. Written as #Experimenter_Name:
  in the file header.'
examples:
- value: John Doe
