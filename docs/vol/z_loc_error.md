...
_Localization error estimate for the Z coordinate of this Spot. Same unit as Z._
...
```yaml
name: z_loc_error
description: Localization error estimate for the Z coordinate of this Spot. Same unit
  as Z.
examples:
- value: '0.05'
