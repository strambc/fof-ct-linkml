...
# Slot: experimenter_contact 


_Email address of the person who performed the experiment. Written as #Experimenter_Contact: in the file header._
...
URI: [fof_ct:experimenter_contact](https://w3id.org/fof-ct/experimenter_contact)
...
| ---  | ---  |
| self | fof_ct:experimenter_contact |
| native | fof_ct:experimenter_contact |
...
description: 'Email address of the person who performed the experiment. Written as
  #Experimenter_Contact: in the file header.'
examples:
