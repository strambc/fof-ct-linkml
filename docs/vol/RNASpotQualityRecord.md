...
```mermaid
 classDiagram
    ...
    click RNASpotQualityRecord href "../RNASpotQualityRecord/"
      RNASpotQualityRecord : centroid_intensity
        
      RNASpotQualityRecord : channel_name
        
      RNASpotQualityRecord : fluorophore_name
        
      RNASpotQualityRecord : goodness_of_fit
        
      RNASpotQualityRecord : peak_intensity
        
      RNASpotQualityRecord : photon_count
        
      RNASpotQualityRecord : raw_x
        
      RNASpotQualityRecord : raw_y
        
      RNASpotQualityRecord : raw_z
        
      RNASpotQualityRecord : rna_spot_id
        
      RNASpotQualityRecord : x_chromatic_shift
        
      RNASpotQualityRecord : x_drift
        
      RNASpotQualityRecord : x_loc_error
        
      RNASpotQualityRecord : x_precision
        
      RNASpotQualityRecord : y_chromatic_shift
        
      RNASpotQualityRecord : y_drift
        
      RNASpotQualityRecord : y_loc_error
        
      RNASpotQualityRecord : y_precision
        
      RNASpotQualityRecord : z_chromatic_shift
        
      RNASpotQualityRecord : z_drift
        
      RNASpotQualityRecord : z_loc_error
        
      RNASpotQualityRecord : z_precision
...
| [x_precision](x_precision.md) | 0..1 <br/> [Float](Float.md) | Metric quantifying the precision of the X-axis localization estimate | direct |
...
| [photon_count](photon_count.md) | 0..1 <br/> [Integer](Integer.md) | Number of photons detected for this localization event or Spot | direct |
...
description: 'A single row in the RNA Spot Quality table. Each instance captures one
  ...
  record in the RNA Spot Data table (table 4). RNA_Spot_ID, Channel and Fluor are
  mandatory; all other reserved quality-metric columns are conditionally required
  (the same reserved vocabulary as the Spot Quality table) or fully free-form; users
  declare the latter via #^ header lines.'
