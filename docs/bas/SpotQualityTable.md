...
URI: [fof_ct:SpotQualityTable](https://w3id.org/fof-ct/SpotQualityTable)
...
```mermaid
 classDiagram
    class SpotQualityTable
    click SpotQualityTable href "../SpotQualityTable/"
      SpotQualityTable : additional_tables
        
          
    
        
        
        SpotQualityTable --> "1..*" TableNamespaceEnum : additional_tables
        click TableNamespaceEnum href "../TableNamespaceEnum/"
    

        
      SpotQualityTable : description
        
      SpotQualityTable : experimenter_contact
        
      SpotQualityTable : experimenter_name
        
      SpotQualityTable : fof_ct_version
        
      SpotQualityTable : intensity_measurement_method
        
      SpotQualityTable : intensity_unit
        
      SpotQualityTable : lab_name
        
      SpotQualityTable : softwares
        
          
    
        
        
        SpotQualityTable --> "*" Software : softwares
        click Software href "../Software/"
    

        
      SpotQualityTable : spot_quality_records
        
          
    
        
        
        SpotQualityTable --> "1..*" SpotQualityRecord : spot_quality_records
        click SpotQualityRecord href "../SpotQualityRecord/"
    

        
      SpotQualityTable : table_namespace
        
      SpotQualityTable : time_unit
        
          
    
        
        
        SpotQualityTable --> "0..1" TimeUnitEnum : time_unit
        click TimeUnitEnum href "../TimeUnitEnum/"
    

        
      SpotQualityTable : xyz_unit
...
| [spot_quality_records](spot_quality_records.md) | 1..* <br/> [SpotQualityRecord](SpotQualityRecord.md) | The complete collection of SpotQualityRecord rows constituting this dataset | direct |
...
| ---  | --- | --- | --- |
| [SpotQualityTable](SpotQualityTable.md) | [spot_quality_records](spot_quality_records.md) | domain | [SpotQualityTable](SpotQualityTable.md) |
...
| ---  | ---  |
| self | fof_ct:SpotQualityTable |
| native | fof_ct:SpotQualityTable |
...
<details>
```yaml
name: SpotQualityTable
description: 'The Spot Quality table of a FOF-bas-CT dataset (namespace: 4dn_FOF-CT_quality).
...
slot_usage:
  ...
  table_namespace:
    ...
    description: 'Identifier for this table type. Must always be ''4dn_FOF-CT_quality''.
...
attributes:
  ...
  spot_quality_records:
    name: spot_quality_records
    description: The complete collection of SpotQualityRecord rows constituting this
      dataset. Each record corresponds to one data row in the TSV serialisation and
      must include at least one user-defined quality metric column.
    from_schema: https://w3id.org/fof-ct/bas
    rank: 1000
