...
# Class: SpotBiologicalTable 


_The Spot Biological Data table of a FOF-bas-CT dataset (namespace: 4dn_FOF-CT_bio). This class represents the entire file: it holds all dataset-level provenance metadata (recorded as header lines in the TSV serialisation) together with the full collection of SpotBiologicalRecord rows. Submission of this table is optional but highly recommended._
...
URI: [fof_ct:SpotBiologicalTable](https://w3id.org/fof-ct/SpotBiologicalTable)
...
```mermaid
 classDiagram
    class SpotBiologicalTable
    click SpotBiologicalTable href "../SpotBiologicalTable/"
      SpotBiologicalTable : additional_tables
        
          
    
        
        
        SpotBiologicalTable --> "1..*" TableNamespaceEnum : additional_tables
        click TableNamespaceEnum href "../TableNamespaceEnum/"
    

        
      SpotBiologicalTable : description
        
      SpotBiologicalTable : experimenter_contact
        
      SpotBiologicalTable : experimenter_name
        
      SpotBiologicalTable : fof_ct_version
        
      SpotBiologicalTable : intensity_measurement_method
        
      SpotBiologicalTable : intensity_unit
        
      SpotBiologicalTable : lab_name
        
      SpotBiologicalTable : softwares
        
          
    
        
        
        SpotBiologicalTable --> "*" Software : softwares
        click Software href "../Software/"
    

        
      SpotBiologicalTable : spot_biological_records
        
          
    
        
        
        SpotBiologicalTable --> "1..*" SpotBiologicalRecord : spot_biological_records
        click SpotBiologicalRecord href "../SpotBiologicalRecord/"
    

        
      SpotBiologicalTable : table_namespace
        
      SpotBiologicalTable : time_unit
        
          
    
        
        
        SpotBiologicalTable --> "0..1" TimeUnitEnum : time_unit
        click TimeUnitEnum href "../TimeUnitEnum/"
    

        
      SpotBiologicalTable : xyz_unit
        
          
    
        
        
        SpotBiologicalTable --> "0..1" XYZUnitEnum : xyz_unit
...
| [spot_biological_records](spot_biological_records.md) | 1..* <br/> [SpotBiologicalRecord](SpotBiologicalRecord.md) | The complete collection of SpotBiologicalRecord rows constituting this datase... | direct |
...
| ---  | --- | --- | --- |
| [SpotBiologicalTable](SpotBiologicalTable.md) | [spot_biological_records](spot_biological_records.md) | domain | [SpotBiologicalTable](SpotBiologicalTable.md) |
...
| ---  | ---  |
| self | fof_ct:SpotBiologicalTable |
| native | fof_ct:SpotBiologicalTable |
...
<details>
```yaml
name: SpotBiologicalTable
description: 'The Spot Biological Data table of a FOF-bas-CT dataset (namespace: 4dn_FOF-CT_bio).
...
slot_usage:
  ...
  table_namespace:
    ...
    description: 'Identifier for this table type. Must always be ''4dn_FOF-CT_bio''.
  ...
  xyz_unit:
    ...
    description: 'Unit used for any spatial coordinate or distance metric reported
      in user-defined columns (e.g. distance from nuclear lamina). Conditionally required
      when any such metric is present. Written as ##XYZ_Unit= in the file header.'
    required: false
  time_unit:
    name: time_unit
...
attributes:
  ...
  spot_biological_records:
    name: spot_biological_records
    description: The complete collection of SpotBiologicalRecord rows constituting
