...
_Name of the laboratory where the experiment was performed. Written as #Lab_Name: in the file header._
...
URI: [fof_ct:lab_name](https://w3id.org/fof-ct/lab_name)
...
| ---  | ---  |
| self | fof_ct:lab_name |
| native | fof_ct:lab_name |
...
```yaml
name: lab_name
description: 'Name of the laboratory where the experiment was performed. Written as
  #Lab_Name: in the file header.'
examples:
- value: Nobel
