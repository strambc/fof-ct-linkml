...
# Slot: table_namespace 


_Identifier for this table type. The required value is specific to each table. Written as ##Table_Namespace= in the file header._
...
URI: [fof_ct:table_namespace](https://w3id.org/fof-ct/table_namespace)
...
| ---  | ---  |
| self | fof_ct:table_namespace |
| native | fof_ct:table_namespace |
...
description: 'Identifier for this table type. The required value is specific to each
  table. Written as ##Table_Namespace= in the file header.'
