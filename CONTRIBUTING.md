# Contributing to fof-ct

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
fof-ct. These guidelines are not strict rules.
...
The fof-ct team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the fof-ct technical leads
...
[issues]: https://github.com/4dn-dcic/fof-ct/issues/
[pulls]: https://github.com/4dn-dcic/fof-ct/pulls/
